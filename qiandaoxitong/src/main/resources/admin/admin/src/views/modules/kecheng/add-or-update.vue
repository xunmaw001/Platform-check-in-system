    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaoshi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="假删" prop="yonghuDelete">
                        <el-input v-model="jiaoshiForm.yonghuDelete"
                                  placeholder="假删" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
            ...
            <input id="jiaoshiId" name="jiaoshiId" type="hidden">
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="课程开始时间" prop="kaishiTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kaishiTime" label="课程开始时间" prop="kaishiTime">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="课程结束时间" prop="jieshuTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jieshuTime" label="课程结束时间" prop="jieshuTime">
